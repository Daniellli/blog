...
/**
 * Servlet implementation class AndroidChangePWDServlet
 */
@WebServlet("/AndroidChangePWDServlet")
public class AndroidChangePWDServlet extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response)
		...
		if (userBiz.updateUserSimply(user)) {
			// 修改成功
			Gson gson = new Gson();
