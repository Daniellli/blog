...
CREATE TABLE `user` (
  ...
  `u_question` varchar(255) COLLATE utf8_bin DEFAULT NULL,
  `u_answer` varchar(45) COLLATE utf8_bin DEFAULT NULL,
  `u_telephone` varchar(255) COLLATE utf8_bin DEFAULT NULL,
  PRIMARY KEY (`u_id`),
...
INSERT INTO `user` VALUES (1,'Daniel','sc18750910084',NULL,NULL,'1',1,'who am i ?','Daniel','18750910084');
