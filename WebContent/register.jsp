...
<script src="../static/js/cxregister.js" type="text/javascript"
...
<body>
	...
	<!--用户注册-->
	<form id="form" name="form" action="../controller/checkLogin.jsp"
		method="post" autocomplete="off">
		<div class="g_register posCenter" style="display: block;">
			<div class="g_r_title">用户注册</div>
			<div class="g_r_form">
				<p class="g_r_tel">
					<input class="g_tel" readonly type="text" placeholder="登录手机号"
				...
				<div
					...
					<input class="radio" type="radio" name="shenfen" value="0" checked />
					用户 <input class="radio" type="radio" name="shenfen" value="1" />管理员
