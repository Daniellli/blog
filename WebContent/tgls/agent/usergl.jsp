...
for (var i=0;i<checkboxs.length;i++) { 
  ...
  setSelectAll(); 
	...
	<div class="cBody">
			...
			<!--留言管理-->	<form method="post" action="deletealluser.jsp">
...
i++;
			...
			<div id="pages"></div>
				第<%=intPage%>页 共<%=intPageCount%>页
					...
					if (intPage < intPageCount) {
				%>
					<a href="usergl.jsp?page=<%=intPage + 1%>">下一页</a>
					<%
						}
						if (intPage > 1) {
					%>
					<a href="usergl.jsp?page=<%=intPage - 1%>">上一页</a>
					<%
						}
						}
											%>
...
<div id="pages">
<form method="POST" action="usergl.jsp">
...
response.sendRedirect("usergl.jsp?page="+Integer.parseInt(request.getParameter("pagenum")));
}
%>
</div>
	</body>
