		...
		<div class="container">
			<div class="row justify-content-center align-items-center d-flex">
				<div class="col-lg-8">
					<div id="imaginary_container">
						<div class="input-group stylish-input-group">
							...
							<input type="text" class="form-control" id="searchBox"
								placeholder="Addictionwhen gambling"
								onfocus="this.placeholder = ''"
								onblur="this.placeholder = 'Addictionwhen gambling '" required>
					...
					<p class="mt-20 text-center text-white">169 results found for
						“Addictionwhen gambling”</p>
				</div>
			</div>
		</div>
	</section>
				...
				<div class="row justify-content-center d-flex">
							...
							<div class="single-list flex-row d-flex">
								...
								<div class="detail">
									...
									<p class="footer pt-20">
										<i class="fa fa-heart-o" aria-hidden="true"></i> <a href="#">06
					...
					<div class="col-lg-4 sidebar-area">
						...
						<div class="single_widget recent_widget">
							...
							<div class="active-recent-carusel">
								<div class="item">
									...
									<p>
										02 Hours ago <span> <i class="fa fa-heart-o"
											aria-hidden="true"></i> 06 <i class="fa fa-comment-o"
											aria-hidden="true"></i>02
										</span>
									</p>
								</div>
								<div class="item">
						...
						<div class="single_widget cat_widget">
							...
							<ul>
								<li><a href="#">Dec'17 <span>37</span></a></li>
								<li><a href="#">Nov'17 <span>37</span></a></li>
								<li><a href="#">Oct'17 <span>37</span></a></li>
								<li><a href="#">Sept'17 <span>37</span></a></li>
								<li><a href="#">Aug'17 <span>37</span></a></li>
								<li><a href="#">Jul'17 <span>37</span></a></li>
								<li><a href="#">Jun'17 <span>37</span></a></li>
							</ul>
						</div>
